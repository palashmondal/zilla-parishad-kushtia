...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Admin and user accounts with role-based access control';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='à¦ªà§à¦°à¦•à¦²à§à¦ª à¦…à¦¨à§à¦®à§‹à¦¦à¦¨ à¦¸à§à¦®à¦¾à¦°à¦• â€” Project approval memos with date, number, and project count';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='প্রকল্পের ছবি — Multiple photos per project with before/during/after classification';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=176 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='প্রকল্পের অগ্রগতির ইতিহাস — Time-series snapshots of project progress for charts';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='প্রকল্প — Government development projects managed by Zilla Parishad Kushtia';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_modules` (
  ...
  CONSTRAINT `user_modules_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `admin_users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `user_modules_ibfk_2` FOREIGN KEY (`granted_by`) REFERENCES `admin_users` (`id`) ON DELETE RESTRICT
